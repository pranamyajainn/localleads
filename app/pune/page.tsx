...
export const metadata: Metadata = {
  title: "Find Businesses Without Website in Pune — LocalLeads",
  description:
    "LocalLeads finds local businesses in Pune with a phone number and no website. Get 20 free leads in minutes — no credit card needed. Used by web freelancers across Pune.",
  alternates: {
    canonical: "https://localleads.sahajta.com/pune",
  },
  openGraph: {
    title: "Find Businesses Without Website in Pune — LocalLeads",
    description:
      "Scan Google Maps for Pune businesses with no website. Free trial, no card.",
    url: "https://localleads.sahajta.com/pune",
  },
};
    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#EDEDED" }}>
      ...
      <section style={{ padding: "80px 40px 60px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <p style={{
          ...
          Pune&apos;s growing SMB market has thousands of businesses — gyms, travel agents, CA firms, restaurants — with a Google Maps listing but no website. LocalLeads surfaces them in minutes.
        </p>
        <p style={{
          ...
          LocalLeads scans Google Maps in real time and shows you every business in Pune with a live phone number and no website. Not a cached list. Live data — with a Google Maps verification link on every lead.
        </p>
        <Link href="/auth" style={{
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          How to find Pune leads
        </h2>
        {[
          { step: "01", title: "Enter business type", desc: "Type any category — restaurants, salons, CA firms, clinics, travel agents. Anything." },
          { step: "02", title: "Enter Pune", desc: "Add specific areas within Pune for more targeted results — localities, neighbourhoods, market areas." },
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Start finding Pune leads today.
        </h2>
