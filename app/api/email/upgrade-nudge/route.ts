...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: "You used your free search — here is what comes next",
      html: `<!DOCTYPE html>
<html>
<body style="font-family:Arial,sans-serif;color:#333;max-width:560px;margin:0 auto;padding:32px 24px;background:#fff;line-height:1.7;font-size:15px">
  ...
  <p>Hi ${firstName},</p>
  <p>You just used your free search on LocalLeads.</p>
  <p>If you found even one business to call, that is proof the product works for you.</p>
  <p>The Starter plan gives you 10 searches a month for &#8377;499 — that is &#8377;17 a day. One website sale pays it back 20 times over.</p>
  <p><strong>What you get with Starter:</strong></p>
  <ul style="padding-left:20px;margin:0 0 20px">
    <li>10 searches per month</li>
    <li>Unlimited leads per search</li>
    <li>CSV export to manage your pipeline</li>
  </ul>
  <p>
