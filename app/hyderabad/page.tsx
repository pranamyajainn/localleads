...
export const metadata: Metadata = {
  title: "Find Businesses Without Website in Hyderabad — LocalLeads",
  description:
    "LocalLeads finds local businesses in Hyderabad with a phone number and no website. Get 20 free leads in minutes — no credit card needed. Used by web freelancers across Hyderabad.",
  alternates: {
    canonical: "https://localleads.sahajta.com/hyderabad",
  },
  openGraph: {
    title: "Find Businesses Without Website in Hyderabad — LocalLeads",
    description:
      "Scan Google Maps for Hyderabad businesses with no website. Free trial, no card.",
    url: "https://localleads.sahajta.com/hyderabad",
  },
};
    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#EDEDED" }}>
      ...
      <section style={{ padding: "80px 40px 60px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <p style={{
          ...
          Hyderabad&apos;s rapidly growing SMB sector has thousands of businesses listed on Google Maps with no website. LocalLeads finds them by area and category in under 10 minutes.
        </p>
        <p style={{
          ...
          LocalLeads scans Google Maps in real time and shows you every business in Hyderabad with a live phone number and no website. Not a cached list. Live data — with a Google Maps verification link on every lead.
        </p>
        <Link href="/auth" style={{
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          How to find Hyderabad leads
        </h2>
        {[
          { step: "01", title: "Enter business type", desc: "Type any category — restaurants, salons, CA firms, clinics, travel agents. Anything." },
          { step: "02", title: "Enter Hyderabad", desc: "Add specific areas within Hyderabad for more targeted results — localities, neighbourhoods, market areas." },
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Start finding Hyderabad leads today.
        </h2>
