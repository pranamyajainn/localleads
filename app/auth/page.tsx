        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          {error && (
            <div style={{
              ...
              fontFamily: "var(--font-sans)", fontSize: 13, color: "#F87171",
            }}>
              {error}
            </div>
          )}
          ...
          >
            {signing ? (
              <span style={{ width: 16, height: 16, border: "1.5px solid #22C55E", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.8s linear infinite", display: "inline-block" }} />
            ) : (
