...
export const metadata: Metadata = {
  title: "Find Businesses Without Website in Mumbai — LocalLeads",
  description:
    "LocalLeads finds local businesses in Mumbai with a phone number and no website. Get 20 free leads in minutes — no credit card needed. Used by web freelancers across Mumbai.",
  alternates: {
    canonical: "https://localleads.sahajta.com/mumbai",
  },
  openGraph: {
    title: "Find Businesses Without Website in Mumbai — LocalLeads",
    description:
      "Scan Google Maps for Mumbai businesses with no website. Free trial, no card.",
    url: "https://localleads.sahajta.com/mumbai",
  },
};
    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#EDEDED" }}>
      ...
      <section style={{ padding: "80px 40px 60px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <p style={{
          ...
          From Andheri to Dadar to Navi Mumbai, thousands of local businesses are on Google Maps with no website. LocalLeads filters them out instantly — business name, phone number, Maps link.
        </p>
        <p style={{
          ...
          LocalLeads scans Google Maps in real time and shows you every business in Mumbai with a live phone number and no website. Not a cached list. Live data — with a Google Maps verification link on every lead.
        </p>
        <Link href="/auth" style={{
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          How to find Mumbai leads
        </h2>
        {[
          { step: "01", title: "Enter business type", desc: "Type any category — restaurants, salons, CA firms, clinics, travel agents. Anything." },
          { step: "02", title: "Enter Mumbai", desc: "Add specific areas within Mumbai for more targeted results — localities, neighbourhoods, market areas." },
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Start finding Mumbai leads today.
        </h2>
