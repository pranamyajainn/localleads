...
export const metadata: Metadata = {
  title: "Find Businesses Without Website in Jaipur — LocalLeads",
  description:
    "LocalLeads finds local businesses in Jaipur with a phone number and no website. Get 20 free leads in minutes — no credit card needed. Used by web freelancers across Jaipur.",
  alternates: {
    canonical: "https://localleads.sahajta.com/jaipur",
  },
  openGraph: {
    title: "Find Businesses Without Website in Jaipur — LocalLeads",
    description:
      "Scan Google Maps for Jaipur businesses with no website. Free trial, no card.",
    url: "https://localleads.sahajta.com/jaipur",
  },
};
    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#EDEDED" }}>
      ...
      <section style={{ padding: "80px 40px 60px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <p style={{
          ...
          Jaipur&apos;s local businesses — from Malviya Nagar to Vaishali Nagar to C-Scheme — are active on Google Maps but thousands have no website. LocalLeads finds them fast.
        </p>
        <p style={{
          ...
          LocalLeads scans Google Maps in real time and shows you every business in Jaipur with a live phone number and no website. Not a cached list. Live data — with a Google Maps verification link on every lead.
        </p>
        <Link href="/auth" style={{
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          How to find Jaipur leads
        </h2>
        {[
          { step: "01", title: "Enter business type", desc: "Type any category — restaurants, salons, CA firms, clinics, travel agents. Anything." },
          { step: "02", title: "Enter Jaipur", desc: "Add specific areas within Jaipur for more targeted results — localities, neighbourhoods, market areas." },
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Start finding Jaipur leads today.
        </h2>
