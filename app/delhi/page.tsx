...
export const metadata: Metadata = {
  title: "Find Businesses Without Website in Delhi — LocalLeads",
  description:
    "LocalLeads finds local businesses in Delhi with a phone number and no website. Get 20 free leads in minutes — no credit card needed. Used by web freelancers across Delhi.",
  alternates: {
    canonical: "https://localleads.sahajta.com/delhi",
  },
  openGraph: {
    title: "Find Businesses Without Website in Delhi — LocalLeads",
    description:
      "Scan Google Maps for Delhi businesses with no website. Free trial, no card.",
    url: "https://localleads.sahajta.com/delhi",
  },
};
    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#EDEDED" }}>
      ...
      <section style={{ padding: "80px 40px 60px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <p style={{
          ...
          Delhi&apos;s local market — from Lajpat Nagar to Karol Bagh to Dwarka — is full of businesses that have never had a website. LocalLeads finds them, verifies them, and gives you a list ready to call.
        </p>
        <p style={{
          ...
          LocalLeads scans Google Maps in real time and shows you every business in Delhi with a live phone number and no website. Not a cached list. Live data — with a Google Maps verification link on every lead.
        </p>
        <Link href="/auth" style={{
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          How to find Delhi leads
        </h2>
        {[
          { step: "01", title: "Enter business type", desc: "Type any category — restaurants, salons, CA firms, clinics, travel agents. Anything." },
          { step: "02", title: "Enter Delhi", desc: "Add specific areas within Delhi for more targeted results — localities, neighbourhoods, market areas." },
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Start finding Delhi leads today.
        </h2>
