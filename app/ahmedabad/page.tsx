...
export const metadata: Metadata = {
  title: "Find Businesses Without Website in Ahmedabad — LocalLeads",
  description:
    "LocalLeads finds local businesses in Ahmedabad with a phone number and no website. Get 20 free leads in minutes — no credit card needed. Used by web freelancers across Ahmedabad.",
  alternates: {
    canonical: "https://localleads.sahajta.com/ahmedabad",
  },
  openGraph: {
    title: "Find Businesses Without Website in Ahmedabad — LocalLeads",
    description:
      "Scan Google Maps for Ahmedabad businesses with no website. Free trial, no card.",
    url: "https://localleads.sahajta.com/ahmedabad",
  },
};
    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#EDEDED" }}>
      ...
      <section style={{ padding: "80px 40px 60px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <p style={{
          ...
          Ahmedabad&apos;s business community — from SG Highway to Maninagar — has thousands of active local businesses with no website. LocalLeads finds them instantly.
        </p>
        <p style={{
          ...
          LocalLeads scans Google Maps in real time and shows you every business in Ahmedabad with a live phone number and no website. Not a cached list. Live data — with a Google Maps verification link on every lead.
        </p>
        <Link href="/auth" style={{
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          How to find Ahmedabad leads
        </h2>
        {[
          { step: "01", title: "Enter business type", desc: "Type any category — restaurants, salons, CA firms, clinics, travel agents. Anything." },
          { step: "02", title: "Enter Ahmedabad", desc: "Add specific areas within Ahmedabad for more targeted results — localities, neighbourhoods, market areas." },
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Start finding Ahmedabad leads today.
        </h2>
